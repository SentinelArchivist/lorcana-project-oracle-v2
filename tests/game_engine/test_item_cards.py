...
class TestItemCards(unittest.TestCase):
    ...
    def test_play_item_card(self):
        ...
        # Create a mock ParsedAbility that matches what our game_engine.py expects
        mock_ability = Mock(spec=ParsedAbility)
        mock_ability.trigger = "ON_PLAY"  # Direct attribute access 
        item_card.abilities = [mock_ability]  # Use the mock instead
